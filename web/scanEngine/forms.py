...
from hunter.validators import validate_short_name
...
class ReportForm(forms.ModelForm):
    ...
    show_hunter_banner = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
                "id": "show_hunter_banner",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['show_hunter_banner'] = key.show_rhunterbanner
    ...
    def set_initial(self):
        self.initial['show_hunter_banner'] = True
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool hunter. https://github.com/yogeshojha/rhunter.
