...
from hunter.definitions import ABORTED_TASK, SUCCESS_TASK
from hunter.tasks import create_scan_activity, initiate_scan, run_command
    ...
    if request.method == "POST":
        ...
        if scheduled_mode == 'periodic':
            ...
            PeriodicTask.objects.create(interval=schedule,
                                        name=task_name,
                                        task='hunter.tasks.initiate_scan',
...
def create_report(request, id):
    ...
    if vuln_report_query.exists():
        ...
        data['show_hunter_banner'] = report.show_rhunterbanner
