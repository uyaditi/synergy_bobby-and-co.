...
from hunter.common_func import *
from hunter.definitions import ABORTED_TASK
from hunter.tasks import *
from hunter.gpt import GPTAttackSuggestionGenerator
from hunter.utilities import is_safe_path
...
class hunterUpdateCheck(APIView):
	def get(self, request):
		req = self.request
		github_api = \
			'https://api.github.com/repos/yogeshojha/hunter/releases'
		...
		current_version = ((os.environ['hunter_CURRENT_VERSION'
							])[1:] if os.environ['hunter_CURRENT_VERSION'
							][0] == 'v'
							else os.environ['hunter_CURRENT_VERSION']).replace("'", "")
